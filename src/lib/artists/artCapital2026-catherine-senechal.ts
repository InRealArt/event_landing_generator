...
export const artCapital2026CatherineSenechalData: ArtistData = {
    name: "Catherine",
    fullName: "Catherine Senechal",
    ...
    profileImage: "/images/artCapital2026/catherine-senechal/c_senechal.webp",
    aboutImage: "/images/artCapital2026/catherine-senechal/c_senechal2.webp",
    backgroundImage: "/images/artCapital2026/catherine-senechal/c_senechal_casionRoyal_background.webp",
    posterImage: "/images/artCapital2026/catherine-senechal/artCapital2026.webp",
    partnershipLabel: "",

    email: "teaminrealart@gmail.com",
    phone: "+33 6 12 34 56 78",
    website: "www.catherinesenechal.com",
    brevoListId: 51, // ID de la liste Brevo 
    socialMedia: {
    ...
    artworks: [
        {
            ...
            image: "/images/artCapital2026/catherine-senechal/pavillonV.webp",
        ...
        },
        {
            ...
            year: null,
            medium: "Huile sur toile",
            dimensions: "81cm x 54cm",
            image: "/images/artCapital2026/catherine-senechal/pause-cafe.webp",
            description: "2021. Huile sur toile",
            price: "€3,800",
            available: true,
        },
        {
            ...
            medium: "Huile sur toile",
            dimensions: "89cm x 116cm",
            image: "/images/artCapital2026/catherine-senechal/pont-alexandre-iii.webp",
            description: "L'artiste adore les Ponts de Paris, dont celui-ci le plus célèbre et le plus beau, entouré par ce magnifique quartier des Invalides, non loin du fameux Musées d'Orsay, du Grand Palais et du Champ de Mars. L'artiste a souhaité peindre ce quartier non seulement parce qu'elle l'aime mais aussi parce qu'elle y habite et contemple quotidiennement la beauté de cet arrondissement. L'artiste a choisi des tons pastels qui donnent envie de se plonger dans ce paysage qui fait rêver. Sans compter les magnifiques nymphes et sculptures qui ornent ce pont et qui lui donnent son chic et son panache ! Si vous voulez prolonger votre visite de Paris, n'hésitez pas à accrocher ce tableau dans votre intérieur, il lui donnera un charme et une élégance inouïe !",
            price: "€15,500",
            available: true,
        },
        {
            ...
            image: "/images/artCapital2026/catherine-senechal/trocadero.avif",
            description: "",
            price: "€6,600",
            available: true,
        },
        {
            ...
            image: "/images/artCapital2026/catherine-senechal/subway.webp",
            description: "",
            price: "€1,600",
            available: true,
        },
        {
            ...
            image: "/images/artCapital2026/catherine-senechal/la-butte-montmartre.webp",
            description: "",
            price: "€4,950",
            available: true,
        }
    ...
    content: {
        ...
        heroSubtitle: "Catherine Senechal",
        ...
        // About Section
        aboutBirthInfo: "Née en 1957 - France",
        aboutDescription: "L'artiste Catherine Senechal fait partie de la communauté InRealArt est une artiste côtée I-CAC",
        aboutQuestion: "",
        aboutQuote: "Quand je ne suis pas devant mon chevalet, j'aime être à l'écoute des bruits, des conversations, des découvertes de nouveaux visages, d’œuvres d'art inédites et de musique classique",
        aboutQuoteAuthor: "- Catherine Senechal",
        ...
        footer: {
            ...
            copyright: "© 2025 Catherine Senechal & InRealArt. Tous droits réservés.",
            legalLinks: {
    ...
    seo: {
        title: "Catherine Senechal - Contemporary French Artist | Abstract Art",
        description: "Discover the contemporary abstract artworks of Catherine Senechal, a French artist exploring colors and new materials",
        keywords: ["Catherine Senechal", "French artist", "abstract art", "contemporary art", "mixed media", "color", "Art Capital 2026"]
    }
}
