...
export const vernissageBercy2026CatherineSenechalData: ArtistData = {
    name: "Catherine",
    ...
    backgroundImage: "/images/vernissageBercy2026/c_senechal_casionRoyal_background.webp",
    posterImage: "/images/vernissageBercy2026/c_senechal2.webp",
    partnershipLabel: "",

    email: "teaminrealart@gmail.com",
    phone: "+33 6 12 34 56 78",
    website: "www.inrealart.com",
    brevoListId: 49, // ID de la liste Brevo 
    socialMedia: {
    ...
    artworks: [
        {
            ...
            image: "/images/vernissageBercy2026/artwork-1.webp",
        ...
        },
        {
            ...
            title: "Grand Palais",
            year: 2021,
            medium: "Huile et collage sur toile",
            dimensions: "40 x 40 cm",
            image: "/images/vernissageBercy2026/artwork-2.webp",
            description: "Plongez dans l'univers dynamique d'« Einstein », un chef-d'œuvre moderne qui célèbre l'éclat de l'intellect humain à travers une mosaïque vibrante de couleurs, de formes et de textes",
            price: "1 600 €",
            available: true,
        },
        {
            ...
            image: "/images/vernissageBercy2026/artwork-3.webp",
            description: "Une grande huile sur toile pour symboliser l'une des plus vieux quartier de Paris et surtout l'un des plus hauts en altitude,d'où l'appellation la Butte Montmartre",
            price: "4 950 €",
            available: true,
        },
    ],
    ...
    content: {
        ...
        // Gallery Section
        galleryMainTitle: "Ministère des Finances 2026",
        ...
        footer: {
            ...
            copyright: "© 2026 Catherine Senechal & InRealArt. Tous droits réservés.",
            legalLinks: {
    ...
    seo: {
        ...
        keywords: ["Catherine Senechal", "French artist", "abstract art", "contemporary art", "mixed media", "color",]
    }
}
