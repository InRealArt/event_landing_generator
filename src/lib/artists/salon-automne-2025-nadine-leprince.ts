...
export const salonAutomne2025NadineLeprinceData: ArtistData = {
    name: "Nadine",
    ...
    posterImage: "/images/salonAutomne2025/nadine-leprince/affiche_salonAutomne2025.webp",
    partnershipLabel: "",

    email: "teaminrealart@gmail.com",
    phone: "+33 6 12 34 56 78",
    website: "www.nadineleprince.com",
    brevoListId: 33, // ID de la liste Brevo 
    socialMedia: {
