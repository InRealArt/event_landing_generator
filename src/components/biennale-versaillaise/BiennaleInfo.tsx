...
const practicalInfo = [
  ...
  {
    label: 'VERNISSAGE',
    content: <>Mardi 31 Mars 2026 à 18h</>,
  },
]

export default function BiennaleInfo() {
  return (
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div className="bg-gray-50 p-10 border-l-4 border-[#c5a059]">
            ...
            <div className="space-y-2 text-sm font-semibold font-montserrat">
              <p>Lucia Mamos-Moreaux</p>
              <Link
                href="mailto:contact@biennale-versaillaise.fr"
                className="text-[#c5a059] hover:underline"
              >
                contact@biennale-versaillaise.fr
              </Link>
            </div>
