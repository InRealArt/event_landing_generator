        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-300 text-sm font-montserrat mb-4">
              Plateforme dédiée à la promotion et à la vente d&apos;œuvres d&apos;art contemporain.
            </p>
            <div className="space-y-2 text-gray-400 text-sm font-montserrat">
              <p>35+ Artistes sélectionnés</p>
              <p>Le catalogue c&apos;est 600+ œuvres soigneusement choisies...</p>
          ...
          <div className="text-center md:text-right">
            ...
            <div className="flex flex-col gap-3 space-y-3 text-gray-300 text-sm font-montserrat">
              <div className="flex justify-center md:justify-end space-x-4">
                {/* LinkedIn */}
                <a
                  href="https://linkedin.com/company/inrealart"
                  target="_blank"
                ...
                {/* Instagram */}
                <a
                  href="https://instagram.com/inrealart"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-white transition-colors"
                >
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm font-montserrat">
              © 2026 InRealArt. Tous droits réservés.
            </p>
