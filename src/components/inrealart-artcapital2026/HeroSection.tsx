  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          src={CONTEST_HERO.backgroundImage}
          alt="Grand Palais - Art Capital 2026"
          fill
          ...
          <div className="lg:col-span-7 xl:col-span-8 space-y-6">
            ...
            <div className="space-y-4 bg-white/10 backdrop-blur-sm p-6 rounded-lg border border-white/20 w-full">
              ...
              <p className="text-xl flex items-center gap-2 text-white font-bricolage">
                <span className="w-2 h-2 bg-[#6052FF] rounded-full animate-pulse shrink-0" aria-hidden />
                Lieu: {CONTEST_HERO.infoBox.lieu}
              </p>
            </div>
          ...
          <div className="lg:col-span-5 xl:col-span-4 flex justify-center lg:justify-end">
            {artworkError ? (
              <span className="text-gray-500 font-bricolage text-sm text-center px-4">
                Affiche Art Capital 2026
              </span>
            ) : (
              <Image
                src={CONTEST_HERO.artworkImage}
                alt="Affiche Art Capital 2026"
                width={280}
                height={480}
