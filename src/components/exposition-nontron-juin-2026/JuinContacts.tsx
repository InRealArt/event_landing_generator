      ...
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          <span className="flex items-center justify-center w-8 h-8 rounded-full border border-gray-100 shrink-0">
            <svg className="w-3.5 h-3.5 text-[#c5a059]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
          </span>
          <Link href={`mailto:${email}`} className="text-sm font-montserrat text-gray-600 hover:text-[#c5a059] transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#c5a059] focus-visible:ring-offset-2">
            {email}
          </Link>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`tel:${phone.replace(/\s/g, '')}`} className="text-sm font-montserrat text-gray-600 hover:text-[#c5a059] transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#c5a059] focus-visible:ring-offset-2">
            {phone}
          </Link>
        </div>
      </div>
...
export default function JuinContacts() {
  return (
    <section id="contacts" className="py-24 bg-[#faf8f4] px-6 border-t border-gray-100">
